      ...
      <div class="container">
        ...
        <div class="intro h-100">
          ...
          <div class="product-test">
            ...
            <h3 class="d-inline-block">Offers list</h3>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h5 class="modal-title" id="editLabel">Edit Offer</h5>
                ...
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <div class="form-group">
                                ...
                                <div class="form-group">
                                  <label for="id">Offer ID </label>
                                  <input type="number" name="id" :class="{ 'is-invalid': form.errors.has('id') }" v-model="form.id" class="form-control" id="id" placeholder="Enter Offer ID">
                              </div>
...
export default {
  ...
  methods:{
    product_update(){
      this.form.put('https://rocky-cliffs-25615.herokuapp.com/api/acceptOrRejectOffer',
    ...
    get_all_offers(){
            axios.get('https://rocky-cliffs-25615.herokuapp.com/api/pendingOffers',
            {headers: { 'Authorization' : 'Bearer '+ token}})
