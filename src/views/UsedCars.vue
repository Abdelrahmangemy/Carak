      ...
      <div class="container">
        ...
        <div class="intro h-100">
          ...
          <div class="product-test">
            ...
            <h3 class="d-inline-block">Used Cars list</h3>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h5 class="modal-title" id="editLabel">Edit Used Car</h5>
                ...
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <div class="form-group">
                                <label for="status">Used Car Status </label>
                                <div class="form-group">
                                  <label for="id">Used Car ID </label>
...
export default {
  ...
  methods:{
    ...
    get_all_cars(){
            axios.get('https://rocky-cliffs-25615.herokuapp.com/api/pendingUsedCars',
            {headers: { 'Authorization' : 'Bearer '+ token}})
