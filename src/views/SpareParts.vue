      ...
      <div class="container">
        ...
        <div class="intro h-100">
          ...
          <div class="product-test">
            ...
            <h3 class="d-inline-block">Spare Parts list</h3>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h5 class="modal-title" id="editLabel">Edit Spare Part</h5>
                ...
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <div class="form-group">
                                <label for="status">Spare Part Status </label>
                                <div class="form-group">
                                  <label for="id">Spare Part ID </label>
                                  <input type="number" name="id" :class="{ 'is-invalid': form.errors.has('id') }" v-model="form.id" class="form-control" id="id" placeholder="Enter Spare id">
                                </div>
...
export default {
  ...
  methods:{
    ...
    product_update(){
      this.form.put('https://rocky-cliffs-25615.herokuapp.com/api/acceptOrRejectSP',
    ...
    get_all_parts(){
            axios.get('https://rocky-cliffs-25615.herokuapp.com/api/pendingSparePart',
            {headers: { 'Authorization' : 'Bearer '+ token}})
            ...
            .then(response => {
              ...
              this.images = 'data:images/jpg;base64,'.concat(this.images.concat(response.data.data)) 
            })
            .catch(error => {
                console.log(error)
            });
